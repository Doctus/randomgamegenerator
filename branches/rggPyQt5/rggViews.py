...
import rggNameGen, rggDice, rggMap, rggTile, rggPog, rggDockWidget, rggDialogs, rggResource, rggSystem, rggSession, rggEvent
...
def respondSurveyAnswers(surveyData, origin):
	d = rggDialogs.surveyResultsDialog(surveyData, str(origin), mainWindow)
