...
import sys, random, math, urllib.request, urllib.error, urllib.parse
import os, os.path
...
# Real translation
def translate(*args):
	return str(QtCore.QCoreApplication.translate(*args))
...
def promptLoadFile(title, filter, dir=''):
	...
	if not filename:
		return None
	return makePortableFilename(str(filename))
