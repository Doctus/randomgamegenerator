...
class CharStatsWidget(QDockWidget):
    ...
    def __init__(self, mainWindow):
        ...
        self.layout.addWidget(QLabel("Skills"), 1, 2)
        self.layout.addWidget(self.skillPointsLabel, 1, 3, 1, 1, Qt.AlignRight)
        self.layout.addWidget(self.skillsScroll, 2, 2, 5, 2)
        self.layout.addWidget(self.addSkillButton, 7, 2)
        self.layout.addWidget(self.removeSkillButton, 7, 3)
        self.layout.addWidget(QLabel("Attributes"), 8, 2, 1, 2)
        self.layout.addWidget(self.attScroll, 9, 2, 5, 2)
        self.layout.addWidget(self.addAttButton, 14, 2)
        self.layout.addWidget(self.removeAttButton, 14, 3)
    ...
    def updateDerivedValues(self):
        baseacv = (self.body.currentIndex()+self.mind.currentIndex()+self.soul.currentIndex()+3)//3
        basedcv = baseacv - 2
