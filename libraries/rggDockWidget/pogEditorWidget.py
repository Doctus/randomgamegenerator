...
from libraries.rggQt import QScrollArea, QDockWidget, QPushButton, QGridLayout, SIGNAL, QImage, QBuffer, Qt, QWidget, QIODevice, QPixmap, QLabel
...
class pogEditorWidget(QDockWidget):
    ...
    def __init__(self, mainWindow):
        ...
        self.connect(self.resizeButton, SIGNAL('clicked()'), self.debugResize)
        #self.cropButton = QPushButton("Crop...", mainWindow)
        #self.connect(self.cropButton, SIGNAL('clicked()'), self.debugCropPrompt)
